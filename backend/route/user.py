...
### 1. Register: สร้าง User ใหม่ (เช็ค Username/Email ซ้ำ + Hash Password)
...
### 2. Get All Users (สำหรับ Admin เท่านั้น)
...
### 3. Get Single User (ดึงข้อมูลรายบุคคล)
...
### 4. Update User (เช็คสิทธิ์เจ้าของบัญชี หรือ Admin)
